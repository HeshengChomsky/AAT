...
def main():
    ...
    parser.add_argument('--game', type=str, default='hopper')
    parser.add_argument('--batch_size', type=int, default=2)
    parser.add_argument('--action_space', type=int, default=6)
    parser.add_argument('--action_type', type=str, default='mujoco')
    #
    parser.add_argument('--target_model_type', type=str, default='D4PG')
    ...
    parser.add_argument('--data_dir_prefix', type=str, default='./attacks/datasets/FGSM_hopper_data/')
    parser.add_argument('--policy_path', type=str, default='./algorithms/models/ppo_Pong_final.pth')
    args = parser.parse_args()

    obss, actions, returns, done_idxs, rtgs, timesteps, deltas = create_dataset(args.num_buffers, args.num_steps,
                                                                                args.game, args.data_dir_prefix,
    ...
    eval_reward = evaluate_trained_model(model, target_model, args.game, args.seed, episodes=args.epochs, target_return=20, max_timestep=args.context_length, model_type=args.target_model_type,is_attack=False,action_type=args.action_type)
